<template>
  <form-wizard @onComplete="onComplete" :shape="circle">
    ...
    <tab-content title="Address">
      <div class="form-group">
        ...
        <input
          ...
          placeholder="Please provide a full address"
          v-model="formData.address"
        >
        <div v-if="hasError('address')" class="invalid-feedback">
          <div class="error" v-if="!$v.formData.address.required">Please provide a full address.</div>
        </div>
      </div>
    </tab-content>
